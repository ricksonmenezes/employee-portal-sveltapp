...
<div>
	<div class="row">
		<div class="col-sm-12">
			<h1>employees</h1>
			<hr><br>
			<Button color="success" on:click={addtoggle}>Add Employee</Button>
			<span style="float: right;">
				<ButtonGroup>
					<Button color="success" >MongoDB</Button>
			...
			<Table hover>
				...
				{#each employees as employee}
					<tr transition:fly="{{ y: 48, duration: 200 }}">
						...
						<Button color="warning" on:click={editEmployee({ employee })}>Update</Button>
						<Button color="danger" on:click={removeEmployee({ employee })}>Delete</Button>
						</span>
						</td>
					</tr>
				{/each}
	...
	<Modal isOpen={addopen} {addtoggle}>
		<ModalHeader {addtoggle}>Add a new employee</ModalHeader>
		<ModalBody>
			<Label for="newname">name:</Label>
			<Input type="text" bind:value={addEmployeeForm.name} placeholder="employee name"/>
			<p></p>
			<Label for="newAuthor">Author:</Label>
			<Input type="text" bind:value={addEmployeeForm.author} placeholder="employee author"/>
			<p></p>
			<Label for="newname">Description:</Label>
			<Input type="text" bind:value={addEmployeeForm.description} placeholder="employee description"/>
		</ModalBody>
		<ModalFooter>
			<Button color="primary" on:click={addEmployee}>
				Add employee
			</Button>
	...
	<Modal isOpen={updateopen} {updatetoggle}>
		<ModalHeader {updatetoggle}>Update employee</ModalHeader>
		<ModalBody>
			<Label for="newname">name:</Label>
			<Input type="text" bind:value={editForm.name} placeholder="employee name"/>
			<p></p>
			<Label for="newAuthor">Author:</Label>
			<Input type="text" bind:value={editForm.author} placeholder="employee author"/>
			<p></p>
			<Label for="newName">Description:</Label>
			<Input type="text" bind:value={editForm.description} placeholder="employee description"/>
		</ModalBody>
		<ModalFooter>
			<Button color="primary" on:click={updateEmployee}>
				Update
			</Button>
